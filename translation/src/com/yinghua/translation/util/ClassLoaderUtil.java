...
public class ClassLoaderUtil
{
	...
	public static void main(String[] args) throws MalformedURLException
	{
		...
		URL url = ClassLoaderUtil.getExtendResource("cache.properties");
        Properties prop = ClassLoaderUtil.getProperties("cache.properties");
		String s = ClassLoaderUtil.getClassLoader()
				.getResource("cache.properties").getPath();
		System.out.println(s);
		System.out.println("1".equals(Objects.toString(prop.get("MAIL_SERVER_INCOMG"),"null")));
